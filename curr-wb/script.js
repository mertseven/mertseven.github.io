document.addEventListener('DOMContentLoaded', () => {
    ...
    // SEMESTER 1
    { id: 'comm1210', code: 'COMM 1210', name: 'FUNDAMENTALS OF COMMUNICATION STUDIES', syllabus: 'Syllabus for Social Theory...', color: '#7DFAFF', tags: ['theory', 'core', 'social', 'communication process', 'communication models', 'semiotics', 'John Fiske', 'intrapersonal communication', 'interpersonal communication', 'group communication', 'mass communication', 'media history', 'orality', 'literacy', 'printing press', 'language', 'philosophy of language', 'linguistic relativity', 'Sapir-Whorf', 'Wittgenstein', 'George Orwell', 'film analysis', 'social constructionism', 'Berger & Luckmann', 'discourse', 'power', 'hegemony', 'functionalism', 'mainstream approaches', 'Shannon-Weaver model', "Lasswell's model", 'persuasion', 'propaganda', 'media effects', 'effects research', 'behaviourism', 'cultivation theory', 'agenda-setting', 'two-step flow', 'uses & gratifications', 'medium theory', 'Toronto School', 'Marshall McLuhan', 'the medium is the message', 'Harold Innis', 'technological determinism', 'critique', 'Raymond Williams', 'cultural materialism', 'Neil Postman', 'foundational'], ects: 5, hours: "3T+0P", lecturer: "Güven Selçuk", category: 'category-semester-1' },
    { id: 'comm1130', code: 'COMM 1130', name: 'VISUAL CULTURE', syllabus: 'Visual Culture details...', color: '#7DFAFF', tags: ['culture', 'visuals', 'core', 'theory', 'visual analysis', 'interpretation', 'gaze', 'scopaphilia', 'voyeurism', 'male-gaze', 'bricolage', 'collage', 'mass communication'], ects: 6, hours: "3T+0P", lecturer: "Gizem Kızıltunalı", category: 'category-semester-1' },
    { id: 'comm1180', code: 'COMM 1180', name: 'PHOTOGRAPHY', syllabus: 'Photography basics...', color: '#7DFAFF', tags: ['visuals', 'practical', 'art', 'History of Photography', 'Camera Settings', 'Exposure Triangle', 'Aperture & Depth of Field', 'Composition', 'Visual Storytelling', 'Color and Light', 'Critical Perspective', 'Conceptual Photo Design', 'Hands-on Practice'], ects: 6, hours: "2T+2P", lecturer: "Simge Gökbayrak", category: 'category-semester-1' },
    { id: 'nmed1201', code: 'NMED 1201', name: 'NEW MEDIA AND COMMUNICATION TECHNOLOGIES', syllabus: 'NMED Tech syllabus...', color: '#FFFFFF', tags: ['new media', 'technology', 'core', 'New Media Landscape', 'Digital Convergence', 'Internet Technologies', 'Social Media Platforms', 'Mobile Technologies', 'Digital Storytelling (Concepts)', 'User-Generated Content', 'Networked Communication', 'Information Society', 'Digital Divide', 'Media Literacy', 'Ethical Issues in New Media', 'Future Media Trends', 'Content Management Systems (CMS)', 'Data & Privacy', 'Impact of Technology on Society', 'Communication Technologies History', 'Critical Analysis of Media', 'MS Word', 'MS Outlook', 'MS Excel', 'Ars Industrialis Manifestos', 'Student Presentations'], ects: 5, hours: "3T+2P", lecturer: "Mert Seven", category: 'category-semester-1' },
    ...
    { id: 'umfd1020', code: 'UMFD 1020', name: 'FOUNDATIONS OF CRITICAL AND ANALYTICAL THINKING', syllabus: '', color: '#C7C7C7', tags: ['design', 'methodology'], ects: 2, hours: "2T+0P", lecturer: "ODL", category: 'category-semester-1' },

    // SEMESTER 2
    { id: 'comm1220', code: 'COMM 1220', name: 'SOCIAL THEORY', syllabus: '', color: '#7DFAFF', tags: ['theory', 'media', 'core', 'sociology', 'social philosophy', 'political philosophy', 'Plato', 'ideal forms', 'Aristotle', 'sovereignty', 'state of nature', 'social contract', 'Hobbes', 'Locke', 'Rousseau', 'empiricism', 'positivism', 'enlightenment', 'Comte', 'Tocqueville', 'Emile Durkheim', 'social facts', 'solidarity', 'anomie', 'collective conscience', 'Hegel', 'Karl Marx', 'dialectical materialism', 'historical materialism', 'critique of political economy', 'capitalism', 'class struggle', 'alienation', 'modernism', 'Erich Fromm', 'existentialism', 'literary analysis', 'Max Weber', 'protestant ethic', 'rationalization', 'ideal types', 'bureaucracy', 'Georg Simmel', 'microsociology', 'Herbert Spencer', 'social Darwinism', 'Chicago School', 'symbolic interactionism', 'pragmatism', 'structural functionalism', 'Talcott Parsons', 'Robert Merton', 'structure vs. agency', 'social stratification', 'Bourdieu', 'habitus', 'cultural capital', 'distinction', 'film analysis', 'foundational'], ects: 5, hours: "3T+0P", lecturer: "Güven Selçuk", category: 'category-semester-2' },
    { id: 'nmed1202', code: 'NMED 1202', name: 'MEDIA HISTORY', syllabus: '', color: '#FFFFFF', tags: ['media', 'history', 'technological development', 'modes of mass communication', 'oral to technological', 'cult'], ects: 5, hours: "3T+0P", lecturer: "Gizem Kızıltunalı", category: 'category-semester-2' },
    { id: 'nmed1204', code: 'NMED 1204', name: 'COMPUTATIONAL THINKING', syllabus: '', color: '#FFFFFF', tags: ['technology', 'programming basics', 'Problem Solving', 'Algorithmic Thinking', 'Decomposition', 'Pattern Recognition', 'Abstraction', 'Logic', 'Data Representation', 'Flowcharts', 'Pseudocode', 'Introduction to Programming', 'MS Word', 'Replit', 'Github', 'Critical Thinking', 'Generative AI', 'Creative Problem Solving', 'Student Presentations'], ects: 5, hours: "3T+0P", lecturer: "Mert Seven", category: 'category-semester-2' },
    { id: 'nmed1206', code: 'NMED 1206', name: 'DIGITAL VISUALIZATION', syllabus: '', color: '#FFFFFF', tags: ['visuals', 'digital', 'design'], ects: 5, hours: "3T+2P", lecturer: "Ayça Durmaz", category: 'category-semester-2' },
    ...
    { id: 'umfd1120', code: 'UFMD 1120', name: 'FOUNDATIONS OF ENTREPRENEURSHIP', syllabus: '', color: '#C7C7C7', tags: ['business'], ects: 2, hours: "2T+0P", lecturer: "ODL", category: 'category-semester-2' },
    { id: 'umfd1220', code: 'UFMD 1220', name: 'FOUNDATIONS OF DESIGN THINKING', syllabus: '', color: '#C7C7C7', tags: ['skills'], ects: 2, hours: "2T+0P", lecturer: "ODL", category: 'category-semester-2' },

    // SEMESTER 3
    { id: 'comm1270', code: 'COMM 1270', name: 'ETHICS, RIGHTS AND FREEDOMS IN COMMUNICATION', syllabus: '', color: '#7DFAFF', tags: ['law', 'ethics', 'media', 'freedom of expression', 'freedom of speech', 'human rights', 'media representations'], ects: 5, hours: "3T+0P", lecturer: "Gizem Kızıltunalı", category: 'category-semester-3' },
    { id: 'comm1140', code: 'COMM 1140', name: 'MEDIA THEORIES', syllabus: '', color: '#7DFAFF', tags: ['media', 'theory', 'core', 'critical theory', 'paradigm', 'Thomas Kuhn', 'Marxism', 'ideology', 'false consciousness', 'base and superstructure', 'Terry Eagleton', 'Frankfurt School', 'Adorno & Horkheimer', 'culture industry', 'commodity fetishism', 'critique', 'Walter Benjamin', 'aura', 'mechanical reproduction', 'Bertolt Brecht', 'NFTs', 'public sphere', 'Jürgen Habermas', 'structural transformation', 'social media', 'structuralism', 'semiotics', 'Saussure', 'signifier/signified', 'Valentin Voloshinov', 'myth', 'Levi-Strauss', 'binary oppositions', 'Roland Barthes', 'mythologies', 'denotation', 'connotation', 'Louis Althusser', 'ideological state apparatuses', 'interpellation', 'subjectivity', 'Stuart Hall', 'Birmingham School', 'cultural studies', 'encoding-decoding', 'reception theory', 'hegemony', 'Gramsci', 'audience studies', 'advertising', 'post-structuralism', 'Michel Foucault', 'power', 'discipline', 'panopticon', 'surveillance', 'political economy of media', 'ownership concentration', 'audience commodity', 'Herman & Chomsky', 'propaganda model', 'digital labour'], ects: 5, hours: "3T+0P", lecturer: "Güven Selçuk", category: 'category-semester-3' },
    { id: 'nmed2201', code: 'NMED 2201', name: 'USER EXPERIENCE DESIGN', syllabus: 'UX Design details', color: '#FFFFFF', tags: ['design', 'ux', 'ui', 'digital'], ects: 5, hours: "2T+2P", lecturer: "Ayça Durmaz", category: 'category-semester-3' },
    { id: 'nmed2117', code: 'NMED 2117', name: 'VIDEO NARRATIVES I', syllabus: '', color: '#FFFFFF', tags: ['video', 'narrative', 'practical', 'Video Production Process', 'Pre-Production', 'Project Planning', 'Scenario-Based Design', 'Idea Development', 'Scriptwriting', 'Mood and Reference Research', 'Casting', 'Photoboard - Storyboard', 'Production Design', 'Video History', 'Analog', 'Digital', 'Team work', 'Mise-en-scene', 'Scene', 'Squence', 'Shot - Take', 'Voice Over', 'Dialogue', 'Location scout', 'Recce', 'Art Direction', 'Styling', 'Fitting', 'SFX in set', 'Hair - MAke up', 'Audition', 'Callback', 'Lenses', 'Camera Angles', 'Framing', 'Continuity'], ects: 6, hours: "2T+2P", lecturer: "Simge Gökbayrak", category: 'category-semester-3' },
    { id: 'nmed2203', code: 'NMED 2203', name: 'BASIC DESIGN FOR DIGITAL ENVIRONMENT', syllabus: '', color: '#FFFFFF', tags: ['design', 'digital', 'foundational', 'Adobe Illustrator', 'Adobe Photoshop', 'Line', 'Shape', 'Space & Perspective', 'Color', 'Composition & Layout', 'Typography', 'Photo Retouching', 'Photo Manipulation', 'Visual Effects'], ects: 6, hours: "4T+2P", lecturer: "Ayça Durmaz", category: 'category-semester-3' },
    ...
    // SEMESTER 4
    { id: 'nmed2122', code: 'NMED 2122', name: 'VIDEO NARRATIVES II', syllabus: '', color: '#FFFFFF', tags: ['video', 'narrative', 'practical', 'advanced', 'Cinematography', 'Camera Techniques', 'Lighting Techniques', 'Audio Recording', 'Adobe Premiere Pro', 'Video Editing', 'Editing Practice', 'Post-Production', 'Action Flow', 'Shot List & Breakdown', 'Sound Design', 'Music and Graphic Integration', 'Moving Camera', 'Offline editing', 'Online editing', 'Color correction', 'Digitizing', 'Composition', 'Interview', 'Interview techniques', 'Shooting'], ects: 6, hours: "2T+2P", lecturer: "Simge Gökbayrak", category: 'category-semester-4' },
    { id: 'nmed2206', code: 'NMED 2206', name: 'DIGITAL CULTURE INVESTIGATIONS', syllabus: '', color: '#FFFFFF', tags: ['web', 'technology', 'new media', 'programming'], ects: 5, hours: "2T+2P", lecturer: "Mert Seven", category: 'category-semester-4' },
    { id: 'nmed2202', code: 'NMED 2202', name: 'SOCIAL NETWORK MEDIA', syllabus: '', color: '#FFFFFF', tags: ['social media', 'new media', 'digital', 'Critical Thinking', 'Network Society', 'Manuel Castells', 'Networked economy', 'New labour exploitation', 'Token Economics', 'Social media business models', 'Social Media Ownership', 'Psychology', 'Human behavior', 'Neuroscience', 'Sensation and Perception', 'Learning and Memory', 'Psychosexual Development', '8 Stages of Development', 'Attachment Theory', 'Kohlberg’s 6 Stages of Moral Development', 'Motivation', "Maslow's Hierarchy of Needs", 'Personality', 'Big Five Personality Traits', 'Introverts-Extraverts', 'Social Thinking', 'Social Influence', 'Aggression', 'Asch Conformity Experiment', "Milgram's Obedience Experiment", 'Cyberpsychology', 'Cyberbullying', 'Dark triad personality', 'Microtargeting', 'Algorithms', 'Sociology', 'Sociological Inquiry', 'Mass Media and Society', 'Media influence', 'Post-truth', 'AI Impact on Society', 'Surveillance', 'Privacy', 'Virtual Communities', 'Brand Communities', 'Support Communities', 'Learning Communities', 'Networking Communities', 'Fan Communities', 'Social Media Landscape', 'Key Social Media Metrics', 'Media Innovation and Entrepreneurship', 'Generative AI', 'MS Word', 'MS Teams', 'Podcast', 'Essay'], ects: 5, hours: "3T+2P", lecturer: "Özlem Ozan", category: 'category-semester-4' },
    { id: 'nmed2204', code: 'NMED 2204', name: 'DIGITAL MARKETING COMMUNICATION', syllabus: '', color: '#FFFFFF', tags: ['strategy', 'communication'], ects: 5, hours: "3T+0P", lecturer: "Özlem Ozan", category: 'category-semester-4' },
    ...
    // SEMESTER 5
    { id: 'comm1250', code: 'COMM 1250', name: 'JOURNALISM', syllabus: '', color: '#7DFAFF', tags: ['journalism', 'writing', 'media'], ects: 6, hours: "3T+0P", lecturer: "Mert Seven", category: 'category-semester-5' },
    { id: 'comm1260', code: 'COMM 1260', name: 'POLITICS, SOCIETY AND MEDIA IN TURKEY', syllabus: '', color: '#7DFAFF', tags: ['politics', 'society', 'media', 'national'], ects: 5, hours: "3T+0P", lecturer: "Sevda Alankuş", category: 'category-semester-5' },
    { id: 'nmed3201', code: 'NMED 3201', name: 'COMMUNICATION RESEARCH AND ETHICS', syllabus: '', color: '#FFFFFF', tags: ['research', 'ethics', 'communication', 'Problem Solving', 'Critical Thinking', 'Scientific inquiry', 'Research design', 'Measuring social life', 'Communication research', 'New media studies', 'Human communication', 'Ethical responsibilities', 'Academic integrity', 'Academic honesty', 'Plagiarism', 'Informed consent', 'Confidentiality', 'Transparency in reporting', 'Qualitative research', 'Quantitative research', 'Mixed methods', 'Sampling strategies', 'Research question formulation', 'Literature review', 'Data collection', 'Data & Privacy', 'Data Representation', 'Pattern Recognition', 'Descriptive statistics', 'Content analysis', 'Nethnography', 'Survey design', 'Online questionnaires', 'Focus groups', 'Interviews', 'Ethnography', 'Transcription', 'Coding', 'Data triangulation', 'YouTube research', 'Online communities', 'Participant recruitment', 'Social media listening', 'Generative AI', 'MS Word', 'MS Excel', 'MS Teams', 'YouTube Data Tools', 'Communalytic', 'QualCoder', 'Google Forms', 'Video Essay', 'Academic Databases'], ects: 6, hours: "3T+2P", lecturer: "Özlem Ozan", category: 'category-semester-5' },
    { id: 'nmed3203', code: 'NMED 3203', name: 'INTERACTIVE MEDIA APPLICATIONS', syllabus: '', color: '#FFFFFF', tags: ['mobile', 'app development', 'technology', 'programming'], ects: 5, hours: "2T+2P", lecturer: "Mert Seven", category: 'category-semester-5' },
    { id: 'nmed3126', code: 'NMED 3126', name: 'SOCIAL MEDIA PLANNING', syllabus: '', color: '#FFFFFF', tags: ['social media', 'strategy', 'planning', 'Social Media Planning', 'Social Media Calendar', 'Digital Media Strategy', 'Target Audience', 'Message', 'Evaluate the Brief', 'Content Creation', 'Design for Social Media', 'Reels production', 'Production for YouTube', 'Videocast production', 'Interview', 'Creative Design', 'Music and Sound Effect Integration', 'Video Editing Implementation', 'Horizontal Video Format', 'Vertical Video Format', 'Strategic Plan', 'Targeted Content Production'], ects: 5, hours: "3T+0P", lecturer: "Simge Gökbayrak", category: 'category-semester-5' },
    ...
    // SEMESTER 6
    { id: 'nmed3202', code: 'NMED 3202', name: 'JOURNALISM STUDIO', syllabus: '', color: '#FFFFFF', tags: ['journalism', 'practical', 'studio'], ects: 6, hours: "4T+2P", lecturer: "Sevda Alankuş", category: 'category-semester-6' },
    { id: 'nmed3130', code: 'NMED 3130', name: 'DIGITAL STORYTELLING', syllabus: '', color: '#FFFFFF', tags: ['digital', 'narrative', 'storytelling', 'Story Structure', 'Seven Elements od Digital Storytelling', 'The Center of Digital Storytelling', 'Script', 'Storytelling with Image', 'Photo Journal', 'Caption', 'Cutline', 'Documentary Photography', 'Storytelling with Video', 'Videography', 'Videographer', 'Storytelling with Audio', 'Sound Design', 'Audio Scprit Writing', 'Podcast', 'Audio Story', 'Music and Sound Effect Integration', 'Video Pre Production Implementation', 'Video Production Implementation', 'Shooting', 'Video Editing Implementation', 'Sound Editing Implementation', 'Photography Shooting Implementation', 'History of Storytelling', 'Self Revelatory', 'Voice Over', 'Experinece'], ects: 6, hours: "3T+2P", lecturer: "Simge Gökbayrak", category: 'category-semester-6' },
    ...
    // SEMESTER 7
    { id: 'nmed4201', code: 'NMED 4201', name: 'NEW MEDIA GRADUATION PROJECT I', syllabus: '', color: '#FFFFFF', tags: ['project', 'graduation', 'capstone'], ects: 10, hours: "2T+4P", lecturer: "Özlem Ozan", category: 'category-semester-7' },
