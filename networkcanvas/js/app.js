...
import {
  applyFiltersToMasterData,
  recalculateNodeMetricsForSubset,
  calculateSociometricStatus,
...
import {
  ...
  findMaximalCliques,
} from "./graph_algorithms.js"; // Import clique functions
...
export function reprocessDataAndRedrawAll() {
  ...
  const activeSociogramData = applyFiltersToMasterData(
    masterSociogramData,
    activeFilters,
  );
